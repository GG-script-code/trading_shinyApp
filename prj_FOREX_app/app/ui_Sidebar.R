...
sidebar<-shinydashboardPlus::dashboardSidebar(
  ...
  ,sidebarMenu(
    ...
    ,myConditionalPanel_Graphs_UI("FX_D1_tab",input_Sidebar="FX_D1_tab"
                                  ...
                                  ,title_HTML="Forex daily data")
    #---------------------------------------------------------------------------
    ,menuItem(text="FOREX W1 data"
              ,tabName="FX_W1_tab"
              ,icon=icon("chart-area")
    )
    ,myConditionalPanel_Graphs_UI("FX_W1_tab",input_Sidebar="FX_W1_tab"
                                  ,select_Input_ID="slcInp_FXrate_w1"
                                  ,action_Button_ID="buttInp_getFXgraphs_w1"
                                  ,title_HTML="Forex weekly data")
    #---------------------------------------------------------------------------
  )
)
